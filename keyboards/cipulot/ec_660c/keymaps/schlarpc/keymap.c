...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    // clang-format off
    [0] = LAYOUT(
        QK_GESC,  KC_1,     KC_2,     KC_3,     KC_4,     KC_5,     KC_6,     KC_7,     KC_8,     KC_9,     KC_0,     KC_MINS,  KC_EQL,   KC_BSPC,  KC_BSPC,  KC_INS,
    ...
    [1] = LAYOUT(
        ...
        _______,  GE_SWAP,  _______,  _______,  _______,  _______,  _______,  _______,  KC_PSCR,  KC_SCRL,  KC_PAUS,  _______,  _______,  _______,            NK_TOGG,
        ...
        _______,  _______,  _______,                      _______,                      _______,  KC_APP,   _______,                      _______,  _______,  _______
    ),
    // clang-format on
};
